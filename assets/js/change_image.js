const MAX_IMAGES = 11+1;
const IMAGE_INFO = [
  "Deconstruction <br> Acrylic on canvas mounted on board, 5x5 ft.",
  "Sisyphus <br> Acrylic on canvas mounted on board 50x50 in.",
